...
class MyColorsPalette{
  static const Color lightBlue = Color(0xFF68D7B9);

  static const Color blue = Color(0xFF5D8CDE);

  static const Color lightGreen = Color(0xFF83FF07);

  static const Color orange = Color(0xFFFF6E07);

  static const Color red = Color(0xFFE51111);
  static const Color lightRed = Color(0xFFE72626);

  static const Color lightPurple = Color(0xFF7C5BD6);
...
class MyColors {
  ...
  static const Color lightBlue = Color(0xFF84BCF3);

  static const Color lightRed = Color(0xFFF38484);
